...
in  upstream
  ...
  with bambik =
    { dependencies =
      [ "aff", "arrays", "avar", "console", "convertable-options", "datetime", "effect", "either", "exceptions", "foldable-traversable", "foreign-object", "integers", "lists", "maybe", "numbers", "ordered-collections", "newtype", "prelude", "profunctor", "profunctor-lenses", "qualified-do", "random", "record", "refs", "strings", "transformers", "tuples", "unsafe-coerce", "variant" ]
